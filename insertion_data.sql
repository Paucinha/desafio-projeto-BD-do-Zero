...
insert into Vehicle_OS (Model, License_plate, V_Year, Vehicle_condition, OS_customer) values('Gol', 'ABC-1234', 1990, 'Brand New', '1'),
...
insert into Mechannic_team(Mec_speciality, Address, Mec_service, Mec_Customer) values ('Old Models', 'Rua Miguel pereira, Volta Redonda - RJ',1, 2),
																					  ('Old Models', 'Rua Miguel pereira, Volta Redonda - RJ', 1, 2),
                                                                                      ('New Models', 'Rua Carlos Guilherme, Volta Redonda - RJ', 1, 4),
                                                                                      ('Any model', 'Rua Henri Lima, Volta Redonda - RJ', 1, 1);
...
desc service;
select * from service;
insert into service (Service_type, Deadline, S_Value, Scustomer) values('Maintenance', '2022-10-31', 1500.00, 1),
...
desc payment;    
select * from payment;
insert into payment(Pay_method, POS, PService, PCustomer) values ('Cash', 2, 1, 2),
																 ('Credit Card', 3, 1, 2),
                                                                 ('Bank Transfer', 4, 1, 4),
                                                                 ('Cash', 2, 1, 1);                                    
