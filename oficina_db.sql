...
CREATE TABLE Mechannic_team(idMechannic_team INT AUTO_INCREMENT PRIMARY KEY,
...
-- Creating table OS
CREATE TABLE OS(idOS INT AUTO_INCREMENT NOT NULL PRIMARY KEY,
                OS_Description VARCHAR(100) NOT NULL
);
                
-- Creating table Payment
CREATE TABLE Payment(idPayment INT AUTO_INCREMENT PRIMARY KEY,
